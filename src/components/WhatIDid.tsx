...
import * as style from "./styles/WhatIDid.styles";
  ...
  */
  ...
  return (
    <div css={style.mainContainer}>
      ...
      <div css={[style.mainGridContainer, scrollFadeInUp]} ref={addScrollAnimationRef}>
        <div css={style.itemContainer} onClick={() => handleModalOpen("Alarm")}>
          <span className="itemDetailButton" css={style.itemDetailButton}>
            클릭하여 자세히 보기
          </span>
          <span css={style.itemTitleLabel}>상황조치도우미</span>
          <div css={style.itemSubtitleContainer}>
            <span css={style.itemSubtitleLabel}>2022.06</span>
            <span css={style.itemSubtitleLabel}>1인 프로젝트</span>
          </div>
          <div css={style.itemDescriptionContainer}>
            <span css={style.itemDescriptionTitleLabel}>대한민국 최전방의 긴급상황 추적관리 시스템</span>
            <span css={style.itemDescriptionSubTitleLabel}>
              상황발생시 각종 정보를 상급부대 내에 빠르게 전파하고 추적관리하는 기능 제공
            </span>
            <ul css={style.itemDescriptionList}>
            ...
            <div css={style.itemUsedLanguageContainer}>HTML, CSS, JavaScript, Classic ASP</div>
          </div>
        </div>
        <div css={style.itemContainer} onClick={() => handleModalOpen("JourneyHub")}>
          <span className="itemDetailButton" css={style.itemDetailButton}>
            클릭하여 자세히 보기
          </span>
          ...
          <div css={style.itemSubtitleContainer}>
            <span css={style.itemSubtitleLabel}>2023.09</span>
            <span css={style.itemSubtitleLabel}>3인 프로젝트</span>
          </div>
          <div css={style.itemDescriptionContainer}>
            <span css={style.itemDescriptionTitleLabel}>설래임이 지속되는 여행 정보 제공 웹앱</span>
            <span css={style.itemDescriptionSubTitleLabel}>각종 국가의 뉴스, 소식, 각종 여행정보 등을 제공</span>
            <ul css={style.itemDescriptionList}>
            ...
            <div css={style.itemUsedLanguageContainer}>React, CSS, TypeScript, Express</div>
          </div>
        </div>
        <div css={style.itemContainer} onClick={() => handleModalOpen("MedicineAlarm")}>
          <span className="itemDetailButton" css={style.itemDetailButton}>
            클릭하여 자세히 보기
          </span>
          <span css={style.itemTitleLabel}>
          ...
          <div css={style.itemSubtitleContainer}>
            <span css={style.itemSubtitleLabel}>2024.04</span>
            <span css={style.itemSubtitleLabel}>3인 프로젝트</span>
          </div>
          <div css={style.itemDescriptionContainer}>
            <span css={style.itemDescriptionTitleLabel}>건강한 삶을 위한 공공데이터 기반 복약지도 어플리케이션</span>
            <span css={style.itemDescriptionSubTitleLabel}>노인을 위한 각종 약품 및 건강 관리 기능을 제공</span>
            <ul css={style.itemDescriptionList}>
            ...
            <div css={style.itemUsedLanguageContainer}>React Native, TypeScript, Expo, Spring, MySQL, AWS</div>
          </div>
        </div>
        <div css={style.itemContainer} onClick={() => handleModalOpen("Portfolio")}>
          <span css={style.itemTitleLabel}>
            <a
          ...
          <div css={style.itemSubtitleContainer}>
            ...
            <span css={style.itemSubtitleLabel}>2024.11</span>
            <span css={style.itemSubtitleLabel}>1인 프로젝트</span>
          </div>
          <div css={style.itemDescriptionContainer}>
            <span css={style.itemDescriptionTitleLabel}>내가 무엇을 하고 싶었는지 기록하는 장소</span>
            <ul css={style.itemDescriptionList}>
            ...
            <div css={style.itemUsedLanguageContainer}>React, Emotion CSS, TypeScript</div>
          </div>
        </div>
      </div>
